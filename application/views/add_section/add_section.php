...
<body>
		<div class="col-lg-12">
          ...
          <div class="panel-heading"><svg class="glyph stroked email"></svg>Add Section</div>
         ...
         <?php echo validation_errors('<div style="color:red;">','</div>');?>
          <div class="form-group has-success">
             ...
             <?php echo form_open('user/insert_section',"class='form-horizontal'");?>
						<fieldset>
							
  
 
  <div class="form-group">
    <label for="sec_name" class="col-md-3 control-label" >Section Name<span style="color:red; font-size:20px">*</span>:</label>
  ...
  <div class="form-group">
    <label for="sec_code" class="col-md-3 control-label" >Section Code<span style="color:red; font-size:20px">*</span>:</label>
    <div class="col-md-4 has-success">
