...
function receivertype(v)
{
	
	if(v=='IN')
	{
		$('.addr-to').css({'display':'block'});			
	 $('.extrnal-org').css({'display':'none'});											
...
// 	}
	 ...
	 var prev='CID/'+authority+'/'+category+'/'+sub_cat+'/';	
...
function note_text_type(){

	if(document.getElementById("note_type1").value == 'note_text'){
		document.getElementById("addr_desig").style.display="none";
		document.getElementById("designation").disabled = true;
        document.getElementById("section").disabled = true;
	...
	else if(document.getElementById("note_type2").value="scan_note")
	{
		document.getElementById("addr_desig").style.display="block";
		document.getElementById("designation").disabled = false;
		document.getElementById("section").disabled = false;
